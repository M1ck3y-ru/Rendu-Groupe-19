...
| JEAN LOUIS Pablo | Dev | pablo.jeanlouis@ynov.com |
| KAMSU Hilary Capriaty | Data | hilarycapriaty.kamsu@ynov.com |
 
## Le point important à savoir
...
Conclusion : on ne déploie pas ce modèle. Pour la démo, on part d'un modèle de
base propre. Le détail des preuves et des recommandations est dans `cyber/`.
 
## Organisation du repo
 
- `cyber/` — audit de sécurité (référentiel ANSSI), plan de remédiation et tests de robustesse
...
Interface web (dans un autre terminal) : voir `devweb/README.md`.
